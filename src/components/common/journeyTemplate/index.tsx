  ...
  return (
    <div className={`mx-[70px] mb-[40px] lg:mx-[10px]`}>
        <SkewBg bgColor={JbgColor}>
            <div className='flex justify-between h-[230.5px] lg:h-[110px] md:h-auto'>
                <div className='flex items-start mt-[31.77px] lg:mt-[0px]'>
                    ...
                    <div className=''>
                        ...
                        <p className={`text-[16px] ${pWidth} font-[400] leading-[24px] mb-[24px] lg:mb-[10px] md:w-full md:pr-3`}>{pText}</p>
