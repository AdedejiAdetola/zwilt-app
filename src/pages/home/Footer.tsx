        ...
        <div className="p-20">
          <SkewBg bgColor="bg-[#525AA0] ">
            <div className="flex flex-col justify-center items-center p-3 mt-7 mb-4">
              <p className=" text-[50px] text-white max-w-[600px] text-center leading-[64px] ">
                ...
                <div className="flex gap-4 mb-3">
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full bg-transparent border-b border-[#969FEF]  py-3 placeholder:text-[#969FEF]"
                    />
                  </div>
                  <div className="flex-1">
                    <input
                      placeholder="Enter your email |"
                      className=" w-full bg-transparent border-[#969FEF] border-b py-3 placeholder:text-[#969FEF]"
                    />
                  </div>
                </div>
                <div>
          ...
          <div className="text-[#fff] mt-32 flex gap-24">
            ...
            <div className="flex-1 ">
              <h3 className="text-[54px] leading-[64px] font-semibold max-w-[779px] -mt-3 mb-16">
                  ...
                  <ul>
                    {listone.map((data) => (
                      <li>
                        <Link
                          href={data.href}
                          className="text-[18px] py-2 mb-4  underlinetext"
                        >
                          {data.name}
                        </Link>
                      </li>
