  ...
  return (
    <div>
      <SkewBg bgColor="bg-[#202229]">
        ...
        <div className="mt-[70px] flex space-x-[183px] lg:block lg:space-x-[0px] lg:mt-[30px]">
          <div className=" ml-[78px] text-[#fff] xl:ml-[40px]">
            <div className="font-[700] text-[54px] w-[379px] leading-[64px] flex h-[192px] xl:text-[36px] xl:w-[400px] xl:h-[100px] sm:w-[350px]">
              <span>
                ...
                at&nbsp; <Groovehq width={192} height={51} className="inline xl:w-[100px] xl:h-[40px]" />
              </span>
            </div>

            <div className="mt-[44px] font-[400] leading-[32px] text-[22px] w-[461px] xl:text-[16px] sm:w-[300px]">
          ...
          <div className="mt-[84px] xl:mt-[50px] xl:pl-[40px]">
            <div className="flex items-center">
              ...
              <div className="text-white">
                <h1 className="font-[600] text-[34px] leading-[22px] mb-[3px] md:text-[24px]">
                  Jason Makki
                </h1>
            ...
            <div>
              <p className="opacity-80 w-[499px] text-white mt-[59px] text-[22px] leading-[32px] mb-[197px] xl:text-[16px] xl:w-[350px] lg:mb-[50px] md:w-[300px]">
                Zwilt enabled us to deliver on time and they’ve been heavy
